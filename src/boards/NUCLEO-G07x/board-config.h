...
#define RADIO_MOSI                                  PA_7    /* D11 ok */
#define RADIO_MISO                                  PA_6    /* D12 ok */
#define RADIO_SCLK                                  PA_5    /* D13 ok */

#if defined( SX1261MBXBAS ) || defined( SX1262MBXCAS ) || defined( SX1262MBXDAS )

#define RADIO_NSS                                   PA_8    /* D7 ok */
#define RADIO_BUSY                                  PB_3    /* D3 ok */
#define RADIO_DIO_1                                 PB_4    /* D5 ok */

#define RADIO_ANT_SWITCH_POWER                      PA_9    /* D8 ok */
#define RADIO_FREQ_SEL                              PA_1    /* A1 ok */
#define RADIO_XTAL_SEL                              PB_1    /* A3 (was PB0) */
#define RADIO_DEVICE_SEL                            PA_4    /* A2 ok */
